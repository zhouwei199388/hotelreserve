...
public interface OrderMapper {
    ...
    @Insert({
        ...
        "roomId, adminId, ",
        "roomNumber, transactionid, ",
        "days, orderNumber, ",
        "note, roomCount, ",
        "status, price, startDate, ",
        "endDate, createTime)",
        "values (#{userid,jdbcType=INTEGER}, #{hotelid,jdbcType=INTEGER}, ",
        "#{roomid,jdbcType=INTEGER}, #{adminid,jdbcType=INTEGER}, ",
        "#{roomnumber,jdbcType=VARCHAR}, #{transactionid,jdbcType=VARCHAR}, ",
        "#{days,jdbcType=INTEGER}, #{ordernumber,jdbcType=VARCHAR}, ",
        "#{note,jdbcType=VARCHAR}, #{roomcount,jdbcType=INTEGER}, ",
    ...
    @Select({
        "select",
        "id, userId, hotelId, roomId, adminId, roomNumber, transactionid, days, orderNumber, ",
        "note, roomCount, status, price, startDate, endDate, createTime",
        "from hotel_order",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @Results({
